                    ...
                    {activeSection === 'Posts' && (
                        <div className="space-y-6">
                            {posts.length === 0 ? (
                                ...
                                posts.map((post, idx) => (
                                    <div key={post.postId || idx} className="group bg-gradient-to-br from-[#e0d8cf]/60 via-[#e0d8cf]/40 to-[#f6ede8]/30 backdrop-blur-sm rounded-2xl p-6 shadow-lg hover:shadow-2xl transition-all duration-500 border border-[#e0d8cf]/40 relative overflow-hidden">
                                        <div className="absolute top-0 right-0 w-20 h-20 bg-gradient-to-br from-[#4a3728]/5 to-transparent rounded-full blur-xl group-hover:scale-150 transition-transform duration-700" />
                                        ...
                                        <div className="flex items-center gap-6 mt-4 pt-4 border-t border-[#e0d8cf]/40 relative z-10">
                                            <button
                                                ...
                                                className={`flex items-center gap-2 transition-all duration-200 ${postLikes[post.postId]?.isLiked
                                                        ? 'text-red-500'
                                            ...
                                            >
                                                <div className="p-2 rounded-xl hover:bg-red-50 transition-colors duration-200">
                                                    <svg
                                                        className="w-5 h-5"
                                                        fill={postLikes[post.postId]?.isLiked ? 'currentColor' : 'none'}
                                                        stroke="currentColor"
                                                        viewBox="0 0 24 24"
                                                    >
                                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2"
                                                ...
                                                <span className="text-sm font-semibold">
                                                    {postLikes[post.postId]?.count ?? post.likesCount ?? 0}
                                                </span>
                                            </button>
