...
const CommentMenuDropdown = ({ isDarkMode, comment, handleCommentAction }: { isDarkMode: boolean; comment: any; handleCommentAction: (action: string, commentId: string, content?: string) => void }) => {
