        ...
        <section className="max-w-5xl mx-auto px-6 py-20">
            <div className="text-center mb-12">
                <div className="inline-flex items-center gap-2 bg-white/60 backdrop-blur-md px-4 py-2 rounded-full mb-4 border border-[#e0d8cf]">
                    ...
                    <span className="text-sm font-semibold text-[#4a3728]">Help Center</span>
                </div>
                    ...
                    <div key={i} className="group relative">
                        ...
                        >
                            <div className="flex justify-between items-center">
                                ...
                                <div
                                    className={`w-10 h-10 rounded-full bg-[#f6ede8] flex items-center justify-center border-2 border-[#e0d8cf] transition-transform duration-300 ${openFaq === i ? "rotate-180" : ""
                                        }`}
                                >
                            ...
                            <div
                                className={`overflow-hidden transition-all duration-300 ${openFaq === i ? "max-h-40 mt-4" : "max-h-0"
                                    }`}
                            >
