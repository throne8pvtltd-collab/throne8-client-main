...
import { UPCOMING_MASTERCLASSES } from "@/features/index";

export default function UpcomingMasterclassesSection() {
    return (
            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-18">
                    {UPCOMING_MASTERCLASSES.map((umc, i) => (
                        <div
                            key={i}
                            className="group relative w-72 rounded-[28px] overflow-hidden border border-[#ece7e2] shadow-lg hover:shadow-2xl transition-all duration-700 cursor-pointer hover:-translate-y-2 reveal-on-scroll mx-auto bg-white"
                ...
                <div className="w-full mt-12 reveal-on-scroll">
